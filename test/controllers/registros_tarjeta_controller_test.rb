...
class RegistrosTarjetaControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create registro_tarjeta" do
    assert_difference("RegistroTarjeta.count") do
      post registros_tarjeta_url, params: { registro_tarjeta: { categoria_id: @registro_tarjeta.categoria_id, concepto: @registro_tarjeta.concepto, fecha: @registro_tarjeta.fecha, importe: @registro_tarjeta.importe } }, as: :json
    end
  ...
  test "should update registro_tarjeta" do
    patch registro_tarjeta_url(@registro_tarjeta), params: { registro_tarjeta: { categoria_id: @registro_tarjeta.categoria_id, concepto: @registro_tarjeta.concepto, fecha: @registro_tarjeta.fecha, importe: @registro_tarjeta.importe } }, as: :json
    assert_response :success
  end
