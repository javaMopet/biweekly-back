...
CuentaContable.create!(
  id: 113_001,
  nombre: 'Crédito de nómina Santander',
  tipo_afectacion: 'C',
  subnivel: 0,
  padre_id: 113_000
)
...
CuentaContable.create!(
  id: 212_001,
  nombre: 'Tarjeta de crédito Like U Santander',
  tipo_afectacion: 'A',
  subnivel: 0,
  padre_id: 212_000
)
CuentaContable.create!(
  id: 212_002,
  nombre: 'Tarjeta de crédito Free Santander',
  tipo_afectacion: 'A',
  subnivel: 0,
  padre_id: 212_000
)
CuentaContable.create!(
  id: 212_003,
  nombre: 'Tarjeta de crédito Scotiabank LMS',
  tipo_afectacion: 'A',
  subnivel: 0,
  padre_id: 212_000
)
CuentaContable.create!(
  id: 212_004,
  nombre: 'Tarjeta de crédito Bancomer LMS',
  tipo_afectacion: 'A',
  subnivel: 0,
  padre_id: 212_000
)
CuentaContable.create!(
  id: 212_005,
  nombre: 'Tarjeta de crédito Liverpool HPM',
  tipo_afectacion: 'A',
  subnivel: 0,
  padre_id: 212_000
)
CuentaContable.create!(
  id: 212_006,
  nombre: 'Tarjeta de crédito Liverpool LMS',
  tipo_afectacion: 'A',
  subnivel: 0,
  padre_id: 212_000
)
CuentaContable.create!(
  id: 212_007,
  nombre: 'Tarjeta de crédito Visa Liverpool',
  tipo_afectacion: 'A',
  subnivel: 0,
  padre_id: 212_000
)
CuentaContable.create!(
  id: 212_008,
  nombre: 'Tarjeta de crédito American Express',
  tipo_afectacion: 'A',
  subnivel: 0,
  padre_id: 212_000
)
...
CuentaContable.create!(
  id: 421_002,
  nombre: 'Interés por inversiones',
  tipo_afectacion: 'A',
  subnivel: 0,
  padre_id: 421_000
)
...
CuentaContable.create!(
  id: 513_005,
  nombre: 'Insumos y accesorios casa',
  tipo_afectacion: 'C',
  subnivel: 0,
  padre_id: 513_000
)
...
CuentaContable.create!(
  id: 560_000,
  nombre: 'Bienes muebles e Inmuebles',
  tipo_afectacion: 'C',
  subnivel: 2,
  padre_id: 500_000
)
CuentaContable.create!(
  id: 561_000,
  nombre: 'Bienes muebles e Inmuebles e intangibles',
  tipo_afectacion: 'C',
  subnivel: 1,
  padre_id: 560_000
)
...
CuentaContable.create!(
  id: 561_002,
  nombre: 'Vehiculos y equipo de transporte',
  tipo_afectacion: 'C',
  subnivel: 0,
  padre_id: 561_000
)
